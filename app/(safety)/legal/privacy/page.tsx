    ...
    <main className="m-4">
      ...
      <ul className="list-disc ml-8 mb-4">
        <li>
          ...
          contacting us, such as your name, email address, billing information,
          and any other details you provide.
        </li>
        <li>
          <strong>Usage Data:</strong> We collect information on how our
          services are accessed and used, such as your IP address, browser type,
          device type, usage statistics, and the time and date of your visits.
        </li>
      </ul>
      ...
      <p className="mb-4">
        ...
        servers, and access controls. However, no method of data transmission
      ...
      <ul className="list-disc ml-8 mb-4">
        <li>
          ...
          our website and providing services to you (e.g., payment processors,
          email providers).
        </li>
        <li>
      ...
      <p className="mb-4">
        ...
        improve the functionality of our services. You can manage your cookie
