...
function PrivacyPolicy() {
  return (
    <main className="m-4">
      ...
      <p className="mb-4">
        At One Alias Service, we value the privacy of our users and are
        committed to protecting the personal information you share with us. This
        Privacy Policy explains how we collect, use, and protect your
        information when you visit or use our website hosting services.
      </p>
      <p className="mb-4">
      ...
      <ol className="list-decimal marker:font-semibold marker:text-xl space-y-6 mt-6">
        <li>
          <h2 className="mb-2 font-semibold text-xl">Information We Collect</h2>
          <p className="mb-4">We collect two types of information:</p>
          <ul className="list-disc ml-8 mb-4">
            <li>
              <strong>Personal Information:</strong> This includes details you
              provide when creating an account, purchasing hosting services, or
              contacting us, such as your name, email address, billing
              information, and any other details you provide.
            </li>
            <li>
              <strong>Usage Data:</strong> We collect information on how our
              services are accessed and used, such as your IP address, browser
              type, device type, usage statistics, and the time and date of your
              visits.
            </li>
          </ul>
        </li>
        ...
        <li>
          ...
          <ul className="list-disc ml-8 mb-4">
            ...
            <li>
              ...
              communications (you may opt out of these at any time).
            </li>
            <li>
        ...
        <li>
          ...
          <p className="mb-4">
            ...
            secure servers, and access controls. However, no method of data
        ...
        <li>
          ...
          <ul className="list-disc ml-8 mb-4">
            <li>
              ...
              operating our website and providing services to you (e.g., payment
              processors, email providers).
            </li>
            <li>
              When required by law or to comply with legal processes, such as
              responding to subpoenas or court orders.
            </li>
            <li>
              In the event of a merger, acquisition, or sale of our business,
              your information may be transferred to the new owners.
            </li>
          </ul>
        </li>
        ...
        <li>
          ...
          <p className="mb-4">
            ...
            device that help us remember your preferences, analyze website
            traffic, and improve the functionality of our services. You can
        ...
        <li>
          ...
          <p className="mb-4">
            ...
            if you wish to exercise your rights regarding your personal
            information, please{" "}
